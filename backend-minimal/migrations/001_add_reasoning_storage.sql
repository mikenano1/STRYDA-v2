...
CREATE INDEX IF NOT EXISTS idx_reasoning_session_id ON reasoning_responses(session_id);
CREATE INDEX IF NOT EXISTS idx_reasoning_model ON reasoning_responses(model);
CREATE INDEX IF NOT EXISTS idx_reasoning_created_at ON reasoning_responses(created_at);
...
CREATE INDEX IF NOT EXISTS idx_chat_messages_reasoning ON chat_messages(id) WHERE reasoning_trace IS NOT NULL;
